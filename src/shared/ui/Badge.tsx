...
const variants = {
  neutral:
    'bg-surface-2 text-fg-secondary border-edge dark:bg-white/[0.06]',
  accent:
  ...
  danger:
    'bg-rose-50 text-rose-700 border-rose-200 dark:bg-rose-500/15 dark:text-rose-300 dark:border-rose-500/25',
  warning:
